...
<h2>자유게시판</h2>
	...
	<button type="button" class="btn btn-sm btn-primary" id="btnWriteForm">글쓰기
	</button>
		...
		<div class="form-group row justify-content-center">
			...
			<div class="w100" style="padding-right:10px">
				...
				<select class="form-control form-control-sm" name="searchType" id="searchType">
					...
					<option value="title" <c:out value="${pagination.searchType == null ? 'selected' : ''}"/>>제목</option>

					<option value="content"<c:out value="${pagination.searchType eq 'content' ? 'selected' : ''}"/>>본문</option>
